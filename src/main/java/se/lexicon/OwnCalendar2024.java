...
public class OwnCalendar2024 {

    public static void main(String[] args) {
//        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
//        Date date = simpleDateFormat.parse("2024-01-01");
        // Extra challange
        // Create your own calendar for the year 2024.
        System.out.println("==================================================================");
        System.out.println("EXTRA CHALLENGE:");
        LocalDate localDate = LocalDate.parse("2024-02-28");
